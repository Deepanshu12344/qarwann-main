            ...
            <div ref={scrollerRef} className="flex min-w-0 flex-1 items-stretch snap-x snap-mandatory gap-6 overflow-x-auto overflow-y-hidden scroll-smooth pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                ...
                <Link to="/trips/$slug" params={{ slug: "jim-corbett-wild-trails-and-forest-escape" }} className="group block h-full">
                  ...
                  <div className="mt-5 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <h2 className="font-serif text-2xl text-primary">Jim Corbett</h2>
                      <p className="mt-1 text-xs tracking-[0.2em] uppercase text-muted-foreground">Wild Trails &amp; Forest Escape</p>
                    </div>
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.7 }} data-getaway-card className="h-full w-[85%] shrink-0 snap-start sm:w-[48%] md:w-[32%]">
                <Link to="/trips/$slug" params={{ slug: "rishikesh-reset-by-the-ganga-weekend-escape" }} className="group block h-full">
                  ...
                  <div className="mt-5 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <h2 className="font-serif text-2xl text-primary">Rishikesh</h2>
                      <p className="mt-1 text-xs tracking-[0.2em] uppercase text-muted-foreground">Reset by the Ganga</p>
                    </div>
                    <span className="mt-1 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-primary/30 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground"><ArrowUpRight className="h-4 w-4" /></span>
                  </div>
                </Link>
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.7 }} data-getaway-card className="h-full w-[85%] shrink-0 snap-start sm:w-[48%] md:w-[32%]">
                <Link to="/trips/$slug" params={{ slug: "coorg-coffee-forests-kodava-culture" }} className="group block h-full">
                  ...
                  <div className="mt-5 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <h2 className="font-serif text-2xl text-primary">Coorg</h2>
                      <p className="mt-1 text-xs tracking-[0.2em] uppercase text-muted-foreground">Coffee, Forests &amp; Kodava Culture</p>
                    </div>
                    <span className="mt-1 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-primary/30 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground"><ArrowUpRight className="h-4 w-4" /></span>
                  </div>
                </Link>
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.7 }} data-getaway-card className="h-full w-[85%] shrink-0 snap-start sm:w-[48%] md:w-[32%]">
                <Link to="/trips/$slug" params={{ slug: "ooty-coonoor-tea-trails-misty-hills-nilgiri-escapes" }} className="group block h-full">
                  <div className="relative aspect-[3/4] overflow-hidden rounded-md bg-muted">
                    <img src={HERO_IMAGES_BY_SLUG.get("ooty-coonoor-tea-trails-misty-hills-nilgiri-escapes")} alt="Tea plantations in Ooty and Coonoor" loading="lazy" width={1280} height={1600} className="h-full w-full object-cover transition-transform duration-[1.4s] ease-out group-hover:scale-[1.05]" />
                    <span className="absolute left-4 top-4 rounded-full bg-background/90 px-3 py-1 text-[10px] tracking-[0.2em] uppercase text-primary">2 nights</span>
                    <span className="absolute right-4 top-4 rounded-full bg-accent px-3 py-1 text-[10px] font-semibold tracking-[0.2em] uppercase text-accent-foreground">On Request</span>
                  </div>
                  <div className="mt-5 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <h2 className="font-serif text-2xl text-primary">Ooty &amp; Coonoor</h2>
                      <p className="mt-1 text-xs tracking-[0.2em] uppercase text-muted-foreground">Tea Trails &amp; Misty Hills</p>
                    </div>
                    <span className="mt-1 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-primary/30 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground"><ArrowUpRight className="h-4 w-4" /></span>
                  </div>
                </Link>
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.7 }} data-getaway-card className="h-full w-[85%] shrink-0 snap-start sm:w-[48%] md:w-[32%]">
                <Link to="/trips/$slug" params={{ slug: "hampi-heritage-weekend-escape" }} className="group block h-full">
                  ...
                  <div className="mt-5 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <h2 className="font-serif text-2xl text-primary">Hampi</h2>
                      <p className="mt-1 text-xs tracking-[0.2em] uppercase text-muted-foreground">Ancient Stones &amp; Stories</p>
                    </div>
                    <span className="mt-1 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-primary/30 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground"><ArrowUpRight className="h-4 w-4" /></span>
                  </div>
                </Link>
              ...
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.7 }} data-getaway-card className="h-full w-[85%] shrink-0 snap-start sm:w-[48%] md:w-[32%]">
                <Link to="/trips/$slug" params={{ slug: "kasauli-colonial-charm-pine-trails-slow-mountain-living" }} className="group block h-full">
                  <div className="relative aspect-[3/4] overflow-hidden rounded-md bg-muted">
                    <img src={HERO_IMAGES_BY_SLUG.get("kasauli-colonial-charm-pine-trails-slow-mountain-living")} alt="Pine-covered hills in Kasauli" loading="lazy" width={1280} height={1600} className="h-full w-full object-cover transition-transform duration-[1.4s] ease-out group-hover:scale-[1.05]" />
                    <span className="absolute left-4 top-4 rounded-full bg-background/90 px-3 py-1 text-[10px] tracking-[0.2em] uppercase text-primary">2 nights</span>
                    <span className="absolute right-4 top-4 rounded-full bg-accent px-3 py-1 text-[10px] font-semibold tracking-[0.2em] uppercase text-accent-foreground">On Request</span>
                  </div>
                  <div className="mt-5 flex items-start justify-between gap-4">
                    <div className="min-w-0">
                      <h2 className="font-serif text-2xl text-primary">Kasauli</h2>
                      <p className="mt-1 text-xs tracking-[0.2em] uppercase text-muted-foreground">Colonial Charm &amp; Pine Trails</p>
                    </div>
                    <span className="mt-1 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-primary/30 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground"><ArrowUpRight className="h-4 w-4" /></span>
                  </div>
                </Link>
